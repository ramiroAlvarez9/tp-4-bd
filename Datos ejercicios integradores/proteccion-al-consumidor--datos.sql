---------------- create's----------------------
/* 
 producto <pid: INT PK, descripcion: VARCHAR(70),
 
 tipo: VARCHAR(40), contenido: VARCHAR(40)>
 
 tipo <tipo: VARCHAR(40)---------------- create's----------------------
/* 
 producto <pid: INT PK, descripcion: VARCHAR(70),
 ...
 direccion: VARCHAR(250), barrio: VARCHAR(50), zona: VARCHAR(60)>
...
CREATE TABLE precio (
    ...
    CONSTRAINT precio_pid_fks FOREIGN KEY (pid) REFERENCES producto(pid),
    CONSTRAINT precio_comercio_fks FOREIGN KEY (comercio) REFERENCES comercio(comercio)
);

---------------- productos ----------------------
INSERT INTO
    producto (pid, descripcion, tipo, contenido)
VALUES
    (100, 'Pera', 'Bolsa', 'Pera'),
...
VALUES
    ...
    (250, 'Bolsa de pochoclos', 'Bolsa', 'Pochoclo'),
    (
        460,
        'Pochoclo dulce Caramelo',
        'Bolsa',
        'Pochoclo, caramelo'
    ),
    (
        480,
        'Pochoclo dulce Chocolate',
        'Paquete',
        'Pochoclo, chocolate'
    ),
...
VALUES
    ...
    (
        'Envase Retornable',
        'Descripcion de Envase Retornable'
    ),
    ('Bandeja', 'Descripcion de Bandeja');

-- -------------- comercios ----------------------
INSERT INTO
    comercio (comercio, nombre, direccion, barrio, zona)
VALUES
...
-- -------------- precios ----------------------
INSERT INTO
    precio (pid, comercio, fecha_registro, precio)
VALUES
